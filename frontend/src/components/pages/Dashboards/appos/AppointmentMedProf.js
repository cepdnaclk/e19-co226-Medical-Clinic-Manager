                ...
                <div className={appointment.accept ?'card bg-success shadow container':'card bg-danger shadow container'}>
                  <div className='card-body bg-light px-3 py-2'>
                    ...
                    <div className='d-flex'>
                      <Button variant='primary' disabled={appointment.accept ? true: false} className='ms-2 bg-success' onClick={() => handleAccept(appointment)}>Accept</Button>
                      <Button variant='primary' disabled={appointment.accept ? false: true} className='ms-2 bg-danger' onClick={() => handleDeny(appointment)}>Deny</Button>
                    </div>
                  </div>
                </div>
              </div>
