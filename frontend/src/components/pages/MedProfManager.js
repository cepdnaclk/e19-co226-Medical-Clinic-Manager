...
export default function MedProfessionals() {
  const [professionals, setProfessionals] = useState(medProfessionalsData);
                ...
                <div className='card shadow container'>
                  <div className='card-body px-3 py-2'>
                    ...
                    <div className='d-flex'>
                      <Button variant='primary' className='ms-2' onClick={() => handleDelete(medProf.id)}>
                        Delete
                      </Button>
                    </div>
                  </div>
