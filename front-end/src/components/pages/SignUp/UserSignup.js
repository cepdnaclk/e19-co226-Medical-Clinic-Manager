...
import SignupUserService from '../../services/signup/SignupUserService';
import { useNavigate } from 'react-router-dom';
import UserSignupimg from './UserSignup.png';
        ...
        <div className='d-flex justify-content-center'>
          <Card className="shadow col-md-4">
            ...
            <h2 className='d-flex justify-content-center'>
                <img src={UserSignupimg} alt=''  style={{ width: '100px', height: 'auto' }} className='img-fluid' />
              </h2>
              <pre></pre>
